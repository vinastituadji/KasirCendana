...
<div style="max-width:640px">
    <div class="card">
        <div class="card-header">
            <span class="card-title">Edit: {{ $produk->NamaProduk }}</span>
        ...
        <div class="card-body">
            <form action="{{ route('kasir.produk.update', $produk) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="Harga" class="form-control" value="{{ old('Harga', $produk->Harga) }}" min="0" step="0.01" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($produk->Gambar)
                        <div style="margin-bottom:10px">
                            <img src="{{ asset('images/products/' . $produk->Gambar) }}" style="width:120px;height:90px;object-fit:cover;border-radius:var(--radius-sm);border:1px solid var(--sand-200)">
                            <div class="text-sm text-muted mt-1">Gambar saat ini. Upload baru untuk mengganti.</div>
                        </div>
                    @endif
